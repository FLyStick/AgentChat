...
# client = ChatOpenAI(api_key="<REDACTED>", base_url="http://70.182.56.16:11000/v1/", model="Qwen2-72B-Instruct")

client = OpenAI(base_url='http://70.182.56.16:11000/v1/', api_key=os.getenv('OPENAI_API_KEY', ''))
tools = [
    {
        "schemas": "function",
        "function": {
